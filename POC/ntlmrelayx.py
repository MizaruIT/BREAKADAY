...
if __name__ == '__main__':
    ...
    parser.add_argument('-codec', action='store', help=f'Sets encoding used (codec) from the target\'s output (default {sys.getdefaultencoding()}). If errors are detected, run chcp.com at the target, '
                                                       'map the result with '
